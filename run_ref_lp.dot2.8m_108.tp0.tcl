...
source $env(INTEL_ASIC)/asicflows/synopsys/tech.dot2.8m_108.tp0/add_va_iso_cell.tcl
source $env(INTEL_ASIC)/asicflows/synopsys/apr/connect_pg_net.tcl
source $env(INTEL_ASIC)/asicflows/synopsys/tech.dot2.8m_108.tp0/set_pg_grid_config.tcl
source $env(INTEL_ASIC)/asicflows/synopsys/tech.dot2.8m_108.tp0/create_power_switch.tcl
source $env(INTEL_ASIC)/asicflows/synopsys/tech.dot2.8m_108.tp0/connect_power_switch.tcl
...
source $env(INTEL_ASIC)/asicflows/synopsys/tech.dot2.8m_108.tp0/connect_sec_pg_power_switch.tcl
source $env(INTEL_ASIC)/asicflows/synopsys/apr/connect_pg_net.tcl
source $env(INTEL_ASIC)/asicflows/synopsys/tech.dot2.8m_108.tp0/route_upf_ao_pg.tcl
source $env(INTEL_ASIC)/asicflows/synopsys/apr/change_names.tcl
