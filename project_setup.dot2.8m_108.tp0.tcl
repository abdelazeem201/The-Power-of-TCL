...
set INTEL_VOLTAGE(WORST)     0.765
set INTEL_TEMPERATURE(WORST) 125
set INTEL_PROCESS(BEST)      1.0
set INTEL_VOLTAGE(BEST)      1.05
set INTEL_TEMPERATURE(BEST)  125
...
set INTEL_HARD_MACRO_NAME         [list SDIO_1V8_N1 ]
...
#SYN setup
dict lappend INTEL_SYN_LIBS target b15_ln_p1222_11x1r1v1_tttt_0.750v_70c_nldm.db
dict lappend INTEL_SYN_LIBS target b15_nn_p1222_11x1r1v1_tttt_0.750v_70c_nldm.db

dict lappend INTEL_SYN_LIBS target ip222rfshpmrom4096x16img0_tttt_0.75v_70c.db
dict lappend INTEL_SYN_LIBS target ip222rfsbhpm1r1w32x32be32m4p4_tttt_0.75v_70c.db
dict lappend INTEL_SYN_LIBS target ip222rfsbhpm1r1w512x128be128m1p4_tttt_0.75v_70c.db
dict lappend INTEL_SYN_LIBS target ip222rfshpm1r1w256x64_tttt_0.75v_70c.db
dict lappend INTEL_SYN_LIBS target ip222rfshpm1r1w32x32_tttt_0.75v_70c.db

dict lappend INTEL_SYN_LIBS target SDIO_1V8_N1_psss_0.765v_1.620v_125c_tttt.db
dict lappend INTEL_SYN_LIBS target SDIO_1V8_E1_psss_0.765v_1.620v_125c_tttt.db



dict set INTEL_SYN_LIBS link_lib {}
dict lappend INTEL_SYN_LIBS search_path $env(INTEL_STDCELLS)/nldm/nn 
dict lappend INTEL_SYN_LIBS mw_ref $env(INTEL_STDCELLS)/milkyway/nn/b15_nn 
dict lappend INTEL_SYN_LIBS mw_ref $env(INTEL_STDCELLS)/milkyway/nn/b15_bonuscore_nn 

dict lappend INTEL_SYN_LIBS search_path $env(INTEL_STDCELLS)/nldm/ln 
dict lappend INTEL_SYN_LIBS mw_ref $env(INTEL_STDCELLS)/milkyway/ln/b15_ln 
dict lappend INTEL_SYN_LIBS mw_ref $env(INTEL_STDCELLS)/milkyway/ln/b15_bonuscore_ln

dict lappend INTEL_SYN_LIBS search_path $env(INTEL_IP_LIBS)/ip222hssp10rom_risecreek_r0.7.0/ip222rfshpmrom4096x16img0/lib
dict lappend INTEL_SYN_LIBS search_path $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w32x32be32m4p4/lib
dict lappend INTEL_SYN_LIBS search_path $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w512x128be128m1p4/lib
dict lappend INTEL_SYN_LIBS search_path $env(INTEL_IP_LIBS)/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w256x64/lib
dict lappend INTEL_SYN_LIBS search_path $env(INTEL_IP_LIBS)/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w32x32/lib

dict lappend INTEL_SYN_LIBS search_path $env(INTEL_IO_LIBS)/SDIO_1V8_N1/lib
dict lappend INTEL_SYN_LIBS search_path $env(INTEL_IO_LIBS)/SDIO_1V8_E1/lib

dict lappend INTEL_SYN_LIBS mkriscv_db $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkriscv.db_lib.db
dict lappend INTEL_SYN_LIBS mkdmem_db $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkdmem.db_lib.db
dict lappend INTEL_SYN_LIBS mkimem_db $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkimem.db_lib.db
 

#APR Setup
dict lappend INTEL_APR_LIBS ln    $env(INTEL_ASIC)/ln_nn_ndms/ln/b15_ln.ndm
dict lappend INTEL_APR_LIBS nn    $env(INTEL_ASIC)/ln_nn_ndms/nn/b15_nn.ndm

dict lappend INTEL_APR_LIBS ln_ls  $env(INTEL_STDCELLS)/ndm/ln/b15_ln_ls.ndm

dict lappend INTEL_APR_LIBS IO_N  $env(INTEL_IO_LIBS)/SDIO_1V8_N1/ndm/SDIO_1V8_N1.ndm
dict lappend INTEL_APR_LIBS IO_E  $env(INTEL_IO_LIBS)/SDIO_1V8_E1/ndm/SDIO_1V8_E1.ndm

dict lappend INTEL_APR_LIBS ip_hs      $env(INTEL_IP_LIBS)/ip222hssp10rom_risecreek_r0.7.0/ip222rfshpmrom4096x16img0/NDM/ip222rfshpmrom4096x16img0.ndm
dict lappend INTEL_APR_LIBS ip_srs     $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w32x32be32m4p4/NDM/ip222rfsbhpm1r1w32x32be32m4p4.ndm
dict lappend INTEL_APR_LIBS ip_rfshpm  $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w512x128be128m1p4/NDM/ip222rfsbhpm1r1w512x128be128m1p4.ndm
dict lappend INTEL_APR_LIBS ip_rfsbhpm $env(INTEL_IP_LIBS)/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w256x64/NDM/ip222rfshpm1r1w256x64.ndm
dict lappend INTEL_APR_LIBS ip_hs_ii   $env(INTEL_IP_LIBS)/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w32x32/NDM/ip222rfshpm1r1w32x32.ndm


##

dict lappend INTEL_APR_LIBS ln_layonly  $env(INTEL_STDCELLS)/ndm/ln/b15_ln_layonly.ndm

dict lappend INTEL_APR_LIBS nn_layonly  $env(INTEL_STDCELLS)/ndm/nn/b15_nn_layonly.ndm
dict lappend INTEL_APR_LIBS nn_ls  $env(INTEL_STDCELLS)/ndm/nn/b15_nn_ls.ndm
dict lappend INTEL_APR_LIBS hn_fib $env(INTEL_STDCELLS)/ndm/hn/b15_hn.ndm

#dict lappend INTEL_APR_LIBS mkfpu $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkfpu.ndm
dict lappend INTEL_APR_LIBS mkriscv_ndm $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkriscv.ndm
dict lappend INTEL_APR_LIBS mkdmem_ndm $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkdmem.ndm
dict lappend INTEL_APR_LIBS mkimem_ndm $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkimem.ndm


#PV Setup
dict lappend INTEL_PV_LIBS max $env(INTEL_STDCELLS)/ccs/nn/b15_nn_p1222_11x1r1v1_tttt_0.750v_70c_ccsn.ldb


dict lappend INTEL_PV_LIBS max $env(INTEL_IP_LIBS)/ip222hssp10rom_risecreek_r0.7.0/ip222rfshpmrom4096x16img0/lib/ip222rfshpmrom4096x16img0_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS max $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w32x32be32m4p4/lib/ip222rfsbhpm1r1w32x32be32m4p4_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS max $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w512x128be128m1p4/lib/ip222rfsbhpm1r1w512x128be128m1p4_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS max $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w256x64/lib/ip222rfshpm1r1w256x64_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS max $env(INTEL_IP_LIBS)/ip222hs4p22rf256x64m1b8by8nnnnnngh/lib/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w32x32/lib/ip222rfshpm1r1w32x32_tttt_0.75v_70c.db


dict lappend INTEL_PV_LIBS min $env(INTEL_STDCELLS)/ccs/nn/b15_nn_p1222_11x1r1v1_tttt_0.750v_70c_ccsn.ldb

dict lappend INTEL_PV_LIBS min $env(INTEL_IP_LIBS)/ip222hssp10rom_risecreek_r0.7.0/ip222rfshpmrom4096x16img0/lib/ip222rfshpmrom4096x16img0_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS min $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w32x32be32m4p4/lib/ip222rfsbhpm1r1w32x32be32m4p4_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS min $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222rfsbhpm1r1w512x128be128m1p4/lib/ip222rfsbhpm1r1w512x128be128m1p4_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS min $env(INTEL_IP_LIBS)/ip222hs2pb11rf_cmo_risecreek_r0.7.0/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w256x64/lib/ip222rfshpm1r1w256x64_tttt_0.75v_70c.db
dict lappend INTEL_PV_LIBS min $env(INTEL_IP_LIBS)/ip222hs4p22rf256x64m1b8by8nnnnnngh/lib/ip222hs2p11rf_risecreek_r0.7.0/ip222rfshpm1r1w32x32/lib/ip222rfshpm1r1w32x32_tttt_0.75v_70c.db


#dict lappend INTEL_PV_LIBS mkimem $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkimem.ldb
#dict lappend INTEL_PV_LIBS mkriscv $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkriscv.ldb
#dict lappend INTEL_PV_LIBS mkdmem $env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkdmem.ldb
...
#}
set INTEL_MACRO_NDM_REF_LIBS [list \
$env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkriscv.ndm \
$env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkimem.ndm \
$env(INTEL_ASIC)/asicflows/synopsys/apr/inputs/mkdmem.ndm \
]
...
set INTEL_LIB_CELL_PURPOSE_LIST(include,optimization) {b15tihi00an1n03x5 b15tilo00an1n03x5} ;# Tie-high cell.
